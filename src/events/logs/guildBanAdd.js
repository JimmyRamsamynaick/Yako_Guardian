...
module.exports = {
    ...
    async execute(client, ban) {
        ...
        const description = await t('logs.descriptions.member_ban', ban.guild.id, { user: ban.user, tag: ban.user.tag });
        
        sendLog(ban.guild, await t('logs.titles.member_ban', ban.guild.id), description, '#FF0000', [
