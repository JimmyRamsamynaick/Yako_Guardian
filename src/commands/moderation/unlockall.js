...
module.exports = {
    ...
    async run(client, message, args) {
        ...
        const replyMsg = await message.channel.send({ embeds: [createEmbed(await t('moderation.unlockall_title', message.guild.id), `${THEME.icons.loading} ${await t('moderation.unlockall_process', message.guild.id)}`, 'loading')] });
        ...
        await replyMsg.edit({ embeds: [createEmbed(
            await t('moderation.unlockall_success_title', message.guild.id),
