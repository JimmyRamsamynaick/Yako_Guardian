...
module.exports = {
    ...
    async run(client, message, args) {
        ...
        const replyMsg = await message.channel.send({ embeds: [createEmbed(await t('moderation.cmute_title', message.guild.id), `${THEME.icons.loading} ${await t('moderation.cmute_loading', message.guild.id)}`, 'loading')] });
        ...
        await replyMsg.edit({ embeds: [createEmbed(
            await t('moderation.cmute_title', message.guild.id), 
